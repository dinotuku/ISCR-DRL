...
THEANO_FLAGS=device=gpu0,floatX=float32 python run_training.py -f $fold --feature $feature_type --directory /home_local/chung95191/ISCR-MDRL/data/$data --result /home_local/chung95191/ISCR-MDRL/result_survey --name $name $type_args
