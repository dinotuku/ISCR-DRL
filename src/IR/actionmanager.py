...
class ActionManager(object):
    ...
    def expand_query(self, params):
        ...
        posmodel = self.expansion(renormalize(self.posprior), self.posdocs,
                                  self.poslengs, self.background)
        negmodel = self.expansion(renormalize(self.negprior), self.negdocs,
                                  self.doclengs, self.background)
